...
class Solution {
    ...
    public boolean isSubtree(TreeNode root, TreeNode subRoot) {
        ...
        navigateStartingFromCurrentNode(root, navigationPathSubRoot);
        return isSubRoot;
    }
    ...
    private void navigateStartingFromCurrentNode(TreeNode currentNode, StringBuilder sb){
        if(currentNode == null)
            return;
        ...
        navigateStartingFromCurrentNode(currentNode.left, sb);
        navigateStartingFromCurrentNode(currentNode.right, sb);
